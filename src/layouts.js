...
export const classic = [
  ...
  [{w:1.5},fn('l-1'),"q","w","e","r","t","y","u","i","o","p","[","]",{w:1.5},fn('r-1'),{x:0.25},fn('del'),fn('end'),fn('pgdown'),{x:0.25},'kp-7','kp-8','kp-9',{h:2},fn('kp-+')],
  [{w:1.75},fn('l-2'),"a","s","d","f","g","h","j","k","l",";","'",{w:2.25},fn('r-2'),{x:3.5},'kp-4','kp-5','kp-6'],
  [{w:2.25},fn('l-3'),"z","x","c","v","b","n","m",",",".","/",{w:2.75},fn('r-3'),{x:1.25},fn('up'),{x:1.25},'kp-1','kp-2','kp-3',{h:2},fn('kp-enter')],
